"""
VirtualStrip class that maps virtual pixels to physical LED strips.
Allows creating virtual strips that span multiple physical strips with
...
class VirtualStrip:
    """Maps virtual strip pixels to one or more physical strips."""

    def __init__(self):
        """Initialize an empty virtual strip."""
