...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            colorWipe(strip, Color(255, 0, 0), wait_ms=25)  # Red wipe
            colorWipe(strip, Color(0, 255, 0), wait_ms=25)  # Green wipe
            colorWipe(strip, Color(0, 0, 255), wait_ms=25)  # Blue wipe
